...
class LocationData:
    ...
    def generateData(self,latV,longV,end,start):
        ...
        # Establishes the parameters of interest when connecting to the APi
        ...
        # Processes the hourly data. The order of variables needs to be the same as requested
        ...
        # Processes the daily data. The order of variables needs to be the same as requested
        ...
        final_dataframe = final_dataframe.join(daily_dataframe['daylight_duration'])

        # Sets the index of the final dataframe as the daylight duration
        final_dataframe = final_dataframe.dropna()
        final_dataframe.set_index('daylight_duration', inplace=True)
    ...
    def getSunData(self,latV,longV,currentDate,startDate):
        ...
        # Calls the method responsible for generating a dataframe of weather data for the next week        
